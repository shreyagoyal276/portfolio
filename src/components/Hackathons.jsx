...
const hackathons = [
  ...
  },
  {
    ...
    team: "Quantum Leap",
    description: "Built a news classification model using semi-supervised learning and trend analysis using APIs. Integrated ML model into MERN stack backend via Flask.",
    tags: ["Trending Products", "Semi-Supervised ML", "Retailer-relevant News feed"],
